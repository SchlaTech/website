  ...
  return (
    <>
      ...
      <main className="mx-auto max-w-5xl px-4 py-12">
        ...
        <section className="mb-12 rounded-xl bg-[color:var(--color-surface)] p-8">
        ...
        <section className="mb-12">
          ...
          <div className="mt-6 space-y-6">
            <div className="rounded-lg border border-[var(--color-border)] bg-white p-5">
              ...
              <p className="mt-2 text-sm text-[color:var(--color-muted)]">Problem: Legacy Windows auth blocked secure remote access and future-proofing.</p>
              <p className="text-sm text-[color:var(--color-muted)]">Solution: Migrated to OAuth 2.0 and Microsoft Entra ID while preserving workflows and updating integrations.</p>
              <p className="mt-2 text-sm font-semibold text-[color:var(--color-muted)]">Impact: Modern authentication, stronger security, and simpler deployments.</p>
            </div>
            <div className="rounded-lg border border-[var(--color-border)] bg-white p-5">
              <h4 className="font-semibold">Production Scheduling Dashboard</h4>
              <p className="mt-2 text-sm text-[color:var(--color-muted)]">Problem: Planners jumped between screens and spreadsheets, slowing decisions.</p>
              <p className="text-sm text-[color:var(--color-muted)]">Solution: Consolidated planning data into a single interface with conflict detection and streamlined updates.</p>
              <p className="mt-2 text-sm font-semibold text-[color:var(--color-muted)]">Impact: Faster planning, fewer errors, and clearer visibility.</p>
            </div>
            <div className="rounded-lg border border-[var(--color-border)] bg-white p-5">
              <h4 className="font-semibold">Cutbill Builder</h4>
              <p className="mt-2 text-sm text-[color:var(--color-muted)]">Problem: Manual cutbill creation took hours and introduced costly mistakes.</p>
              <p className="text-sm text-[color:var(--color-muted)]">Solution: Desktop application automated calculations and exported production-ready files.</p>
              <p className="mt-2 text-sm font-semibold text-[color:var(--color-muted)]">Impact: Reduced a multi-hour task to seconds and saved 250+ hours per year.</p>
            </div>
          </div>
          <div className="mt-6">
            <Link href="/portfolio" className="font-semibold text-[var(--color-teal)]">Explore all case studies →</Link>
          </div>
        </section>
        ...
        <section className="mb-12 rounded-xl bg-white p-6">
          ...
          <div className="flex flex-wrap gap-2">
            {[
              ...
              <span key={t} className="rounded-full border border-[var(--color-border)] px-3 py-1 text-sm text-[color:var(--color-muted)]">{t}</span>
            ))}
          </div>
        </section>
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-start">
            ...
            <div className="md:flex-1">
              ...
              <div className="mt-6">
                ...
                <div className="mt-4">
                  <Link href="/#contact" className="inline-flex items-center gap-2 rounded bg-[var(--color-teal)] px-4 py-2 font-semibold text-white">Request a consult</Link>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-12 rounded-xl bg-white p-8">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-3">
            <div className="rounded-lg border border-[var(--color-border)] bg-white p-4">
              <h4 className="font-semibold">1. Diagnose the bottleneck</h4>
            ...
            <div className="rounded-lg border border-[var(--color-border)] bg-white p-4">
              <h4 className="font-semibold">2. Design the right fit</h4>
            ...
            <div className="rounded-lg border border-[var(--color-border)] bg-white p-4">
              <h4 className="font-semibold">3. Build and refine</h4>
        ...
        <section className="mb-12 rounded-xl bg-[var(--color-teal)] px-6 py-12 text-center text-white">
          ...
          <Link href="/#form" className="inline-block rounded bg-white px-6 py-3 font-semibold text-[var(--color-teal)] transition hover:bg-[color:var(--color-accent)]">Contact Us</Link>
        </section>
